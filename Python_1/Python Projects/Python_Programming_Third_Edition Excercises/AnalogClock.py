print('The clock will start now!')
#remember (note for abhyut) wndw is for the TURTLE window only use it for that purpose
import turtle
import time
...
wndw.title("Abhyut Tangri's Analogue Clock")
wndw.tracer(0)

# Set up a drwing tool
pen = turtle.Turtle()
pen.hideturtle()
pen.speed(0)
pen.pensize(3)
